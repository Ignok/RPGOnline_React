  ...
  function validateForm() {
    ...
    if (!values.JsonReq.Characteristics) {
      errors.Characteristics =
        "For playable characters characteristics are required";
    }
